...
class TPFragmentUnpacker(FragmentUnpacker):
    ...
    def unpack(self, frag):
        ...
        tp_array = []
        tp_size = fddetdataformats.trigger_primitive.TriggerPrimitive.sizeof()
        ...
        for i in range(n_frames):
            tp = fddetdataformats.trigger_primitive.TriggerPrimitive(frag.get_data(i*tp_size))
