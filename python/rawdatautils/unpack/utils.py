        ...
        for i_tc in range(self.get_n_obj(frag)):
            ...
            for i_ta in range(len(tc)):
                ...
                ta_list.append( TriggerActivityData(run=frh.run_number,
                                                    ...
                                                    src_id=frh.element_id.id,
                                                    id=i_ta,
                                                    time_start=ta.time_start,
                                                    time_end=ta.time_end,
                                                    time_peak=ta.time_peak,
                                                    time_activity=ta.time_activity,
                                                    channel_start=ta.channel_start,
    ...
    def get_det_data_all(self,frag):
        ...
        if get_ana_data:
            ...
            ana_data = [ DAPHNEAnalysisData(run=frh.run_number,
                                            ...
                                            offline_channel=self.channel_map.get_offline_channel_from_det_crate_slot_stream_chan(det, crate, slot, stream, daphne_headers[iframe].channel),
