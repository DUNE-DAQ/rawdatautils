...
@click.option('--ftype', type=click.Choice(['wib2','wibeth'], case_sensitive=True), default='wibeth', help="Format to convert to")

def main(fromf, tof, ftype):
    """This script converts ProtoWIB binary files into either WIB2 or WIBETH format"""
